...
from render.render_rgb import render_rgb_from_depth
...
def render_object_views(pcd_path, object_name):
    ...
    for i, cam_pos in enumerate(camera_positions):
        ...
        depth, mask = render_pointcloud(pcd, pose)
        
        rgb = render_rgb_from_depth(depth, mask)
        ...
        rgb_path = os.path.join(out_dir, f"view_{i}_rgb.png")
